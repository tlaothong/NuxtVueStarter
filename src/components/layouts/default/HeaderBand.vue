  ...
  <header>
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <a href="https://github.com/tlaothong"
          class="flex items-center">
          <img src="/imgs/logobigdata.png"
        ...
        <div class="flex items-center lg:order-2">
          <button data-tooltip-target="tooltip-dark"
            ...
            <Icon name="ic:baseline-dark-mode"
              class="w-6 h-6"></Icon>
          </button>
          <div id="tooltip-dark"
            role="tooltip"
          ...
          <button data-tooltip-target="tooltip-statistics"
            ...
            <Icon name="mdi:report-areaspline"
              class="w-6 h-6"></Icon>
          </button>
...
import TopMenu from '../_shared/TopMenu.vue';
</script>